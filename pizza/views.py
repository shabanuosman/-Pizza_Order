...
def order(request):
    ...
    if request.method == 'POST':
        ...
        if filled_form.is_valid():
           ...
           #filled_form =PizzaForm()
        return render(request,'pizza/order.html',{'created_pizza_pk':created_pizza_pk,'pizza_form':filled_form,'note':note,'multiple_form':multiple_form})
